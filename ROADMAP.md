...
> **Durum:** Faz 0 ✅ (M0–M2) · **Faz 1: M3 ✅ · M4 ✅ · M5 ✅ (a–e)** (RNG + tur zamanı; lastik/yakıt/hava; yarış motoru; güvenilirlik + pilot hataları + çarpışma + start + nötralizasyon (SC/VSC/kırmızı) + zengin telemetri & olay günlüğü, CI yeşil) · **Sıradaki: M6** (trafik: kirli hava, slipstream/DRS, gerçek geçiş) · Marka kiti + UI mockup teslim alındı (`design/`)
