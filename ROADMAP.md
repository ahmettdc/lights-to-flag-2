...
> **Durum:** Faz 0 ✅ (M0–M2) · **Faz 1 başladı: M3 ✅** (deterministik RNG + sektör bazlı tur zamanı, CI yeşil) · **Sıradaki: M4** (lastik + yakıt + hava) · Marka kiti + UI mockup teslim alındı (`design/`)
